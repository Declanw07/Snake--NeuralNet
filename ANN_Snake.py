...
class SnakeNN:
    ...
    def __init__(self, initial_games=100000, test_games=10000, goal_steps=2000, lr=1e-2, filename='SNN_2.tflearn'):
    ...
    def initial_population(self):
        ...
        for _ in range(self.initial_games):
            ...
            for _ in range(self.goal_steps):
                ...
                # If goal is reached add this attempt to the training data.
                if done:
                    # Add data from this current attempt to the training data.
